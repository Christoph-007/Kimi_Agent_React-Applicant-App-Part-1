...
export function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Automatic detection: pass empty string for userType to the login function
      // The backend will now detect if it's an admin, employer, or applicant
    ...
    <div className="w-full max-w-md">
      ...
      <div className="rounded-3xl p-8 shadow-2xl" style={{ backgroundColor: '#ffffff' }}>
        <div className="text-center mb-10">
          ...
          <p className="text-gray-500 font-medium">Access your account securely</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-center gap-2 cursor-pointer group w-fit">
            <input type="checkbox" className="w-4 h-4 rounded border-gray-300 accent-lime-400 cursor-pointer" id="remember" />
            <label htmlFor="remember" className="text-sm text-gray-600 font-medium cursor-pointer group-hover:text-gray-900 transition-colors">
