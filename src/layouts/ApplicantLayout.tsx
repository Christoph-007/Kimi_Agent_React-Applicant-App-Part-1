...
const applicantNavItems = [
  { to: '/applicant/home', icon: Home, label: 'Home' },
  { to: '/applicant/jobs', icon: Search, label: 'Browse Jobs' },
  { to: '/applicant/my-jobs', icon: Briefcase, label: 'My Jobs' },
  { to: '/applicant/shifts', icon: Calendar, label: 'My Shifts' },
  { to: '/applicant/attendance', icon: ClipboardList, label: 'Attendance' },
];

const bottomNavItems = [
  { to: '/applicant/notifications', icon: Bell, label: 'Notifications', badge: true },
      ...
      <header className="fixed top-0 left-0 right-0 h-16 bg-forest-900 z-50 shadow-md">
        <div className="h-full px-4 lg:px-8 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <NavLink to="/applicant/home" className="flex items-center gap-2.5 group">
