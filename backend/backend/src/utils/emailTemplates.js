...
const employerSignupTemplate = (employerName, storeName) => {
    return {
        subject: 'Welcome to ShiftMaster - Account Pending Approval',
        html: `
      <!DOCTYPE html>
      <html>
      <head>
      ...
      <body>
        <div class="container">
          <div class="header">
            <h1>Welcome to ShiftMaster!</h1>
          </div>
          <div class="content">
            <h2>Hello ${employerName},</h2>
            <p>Thank you for registering <strong>${storeName}</strong> on ShiftMaster!</p>
          ...
          <div class="footer">
            <p>&copy; 2026 ShiftMaster. All rights reserved.</p>
          </div>
        </div>
      </body>
      </html>
    `,
        text: `Welcome to ShiftMaster!\n\nHello ${employerName},\n\nThank you for registering ${storeName} on ShiftMaster! Your account is currently pending approval by our admin team. You will receive another email once your account has been approved.\n\nThis usually takes 24-48 hours. Thank you for your patience!`,
    };
};
...
const employerApprovalTemplate = (employerName, storeName) => {
    return {
        subject: 'Your ShiftMaster Account Has Been Approved!',
        html: `
      <!DOCTYPE html>
      <html>
      <head>
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <p>Your ShiftMaster account for <strong>${storeName}</strong> has been approved!</p>
            <p>You can now:</p>
            <ul>
            ...
            <p>Thank you for choosing ShiftMaster!</p>
          </div>
          <div class="footer">
            <p>&copy; 2026 ShiftMaster. All rights reserved.</p>
          </div>
    ...
    `,
        text: `Congratulations ${employerName}!\n\nYour ShiftMaster account for ${storeName} has been approved! You can now post jobs, manage applications, create shifts, and track attendance.\n\nThank you for choosing ShiftMaster!`,
    };
};
...
const applicantSignupTemplate = (applicantName) => {
    return {
        subject: 'Welcome to ShiftMaster!',
        html: `
      <!DOCTYPE html>
      <html>
      <head>
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <p>Thank you for joining ShiftMaster!</p>
            <p>You can now:</p>
            <ul>
    ...
    `,
        text: `Welcome to ShiftMaster!\n\nHello ${applicantName},\n\nThank you for joining ShiftMaster! You can now browse jobs, apply for positions, manage shifts, and track your attendance.\n\nGood luck with your job search!`,
    };
};
