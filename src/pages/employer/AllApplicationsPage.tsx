            ...
            <div key={application._id} className="bg-white rounded-2xl p-6 shadow-card border border-gray-50 hover:border-gray-200 transition-colors">
              <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
                ...
                <div className="flex flex-col gap-2">
                  <button
                    onClick={() => handleViewResume(application.applicant._id, application.applicant?.name || 'Applicant')}
      ...
      {previewData && (
        <div className="fixed inset-0 bg-black/60 z-[60] flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl w-full max-w-4xl max-h-[90vh] flex flex-col shadow-2xl overflow-hidden border border-gray-100">
            ...
            <div className="flex-1 overflow-hidden relative bg-cream-50/50 p-12 text-center flex flex-col items-center justify-center">
              ...
              <h3 className="text-2xl font-extrabold text-forest-900 mb-2">Resume Preview Ready</h3>
              <p className="text-gray-500 mb-10 max-w-sm font-medium">
                The applicant's resume is available. Click below to view it in full resolution and high detail in a new browser tab.
              </p>
              ...
              <div className="flex flex-col gap-4 w-full max-w-xs">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="btn-primary py-4 px-8 text-lg flex items-center justify-center gap-3 shadow-btn active:scale-95 transition-all text-white"
                >
