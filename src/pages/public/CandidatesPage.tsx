                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-16">
                        ...
                        <div className="hidden md:flex items-center gap-8">
                            ...
                            <NavLink to="/candidates" className="text-white hover:text-lime transition-colors">Find Candidates</NavLink>
                    ...
                    <div className="grid lg:grid-cols-4 gap-8">
                        <div className="lg:col-span-1 space-y-6">
                            ...
                            <div className="bg-forest-900 rounded-2xl p-6 text-white shadow-lg">
                                ...
                                <NavLink to="/register/employer" className="block w-full py-3 bg-lime text-forest-900 text-center rounded-xl font-bold hover:bg-lime-400 transition-colors">
                                    Get Started
                                </NavLink>
                            </div>
                        </div>
