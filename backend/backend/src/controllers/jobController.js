...
const getAllJobs = async (req, res) => {
    try {
        ...
        if (category) {
            ...
            searchArray.push({ description: new RegExp(category, 'i') });
            // Also match against requirements.skills if they exist
            searchArray.push({ 'requirements.skills': new RegExp(category, 'i') });
        }
...
const getLandingStats = async (req, res) => {
    try {
        ...
        // Mocking avg response time for now, or could be calculated from application history
