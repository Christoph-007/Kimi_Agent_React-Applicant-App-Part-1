...
if ($result1 -and $result1.success) {
    ...
    Write-Host "   ⚠️  Employer 1 may already exist or failed to create" -ForegroundColor Yellow
}
...
if ($result2 -and $result2.success) {
    ...
    Write-Host "   ⚠️  Employer 2 may already exist or failed to create" -ForegroundColor Yellow
}
...
if ($result3 -and $result3.success) {
    ...
    Write-Host "   ⚠️  Applicant 1 may already exist or failed to create" -ForegroundColor Yellow
}
...
if ($result4 -and $result4.success) {
    ...
    Write-Host "   ⚠️  Applicant 2 may already exist or failed to create" -ForegroundColor Yellow
}
...
if ($result5 -and $result5.success) {
    ...
    Write-Host "   ⚠️  Applicant 3 may already exist or failed to create" -ForegroundColor Yellow
}
